...
public class MainApp3 {
    ...
    /**
     * 方法 {@link CompletableFuture#thenCombine(CompletionStage, BiFunction)} 的作用是
     * 开启两个异步线程，让上一个任务和这个任务一起执行，当两个任务都执行完成后，得到两个结果，
     * 再把两个结果拼接起来
     */
     ...
     * <p>
     * 但是，在 {@link CompletableFuture} 中，为这种场景也提供了支持。详见 {@link MainApp3#thenCombineCase()}
     */
